    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="password" class="form-control" id="title" name="newPW" placeholder="New Password">
          </div>
          <div class="form-group">
            <label for="subject">Confirm New Password</label>
            <input type="password" class="form-control" id="title" name="confPW" placeholder="Confirm New Password">
          </div>
      </div>
